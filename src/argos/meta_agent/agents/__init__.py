...
This sub-package provides abstract base classes for agents and agent
factories, along with a concrete runnable-based agent implementation and
a dataclass for agent configuration.
"""
