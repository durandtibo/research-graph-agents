...
A batch is an indexed collection of entities keyed by their IDs. Batches
are the primary data structure used to pass groups of examples or
records through the meta-agent pipeline.
"""
