...
This sub-package provides the abstract base class for evaluators and
concrete implementations that compare agent predictions against
benchmark targets to compute evaluation metrics.
"""
