...
This sub-package provides the abstract base class for predictors
and concrete implementations that run an agent over all examples
in a benchmark and collect the prediction results.
"""
