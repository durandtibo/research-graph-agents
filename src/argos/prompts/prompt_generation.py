...
These prompts instruct a meta-agent LLM on how to iteratively generate
improved system prompts based on performance history and error analysis
from previous optimization iterations.
"""
